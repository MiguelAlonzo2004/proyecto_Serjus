...
from .serializers import (
    ...
    TerminacionlaboralSerializer, TipodocumentoSerializer, UsuarioSerializer, EstadoSerializer, CapacitacionSerializer, PuebloSerializer, CriterioevaluacionSerializer
)
